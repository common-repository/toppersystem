...
class TopperSystemExecuteFileSaveStatusAutoUpdateTS {
...
if(($paginaprovenienzats != "$paginaprovenienzats_controllo")){
    if((isset($_SERVER["REMOTE_ADDR"]))&&(trim($_SERVER["REMOTE_ADDR"]) != "")){
		if((isset($_SERVER["HTTP_USER_AGENT"]))&&(trim($_SERVER["HTTP_USER_AGENT"]) != "")){ 
	        ...
	        if((isset($_POST["autoupdate_service_save"]) && trim($_POST["autoupdate_service_save"]) != "")) {
		        $autoupdate_service_save=wp_kses(trim(TopperSystemSafeNOSQL::sanitizeNosql($_POST['autoupdate_service_save'])), array());	
	        }else{
		        $autoupdate_service_save="";
	        }			
            ...
            if($hreflang_toppersystem == "it"){    
			   ...
			   $txtts3="Gli aggiornamenti automatici sono stati attivati con successo";
			   $txtts4="Gli aggiornamenti automatici sono stati disattivati con successo";
			   ...
			   $txtts3="تم تفعيل التحديثات التلقائية بنجاح";
			   $txtts4="تم تعطيل التحديثات التلقائية بنجاح";
			   ...
			   $txtts3="Automatische Updates wurden erfolgreich aktiviert";
			   $txtts4="Automatische Updates wurden erfolgreich deaktiviert";
			   ...
			   $txtts3="Las actualizaciones automáticas se han activado con éxito";
			   $txtts4="Las actualizaciones automáticas se han deshabilitado con éxito";
			   ...
			   $txtts3="Les mises à jour automatiques ont été activées avec succès";
			   $txtts4="Les mises à jour automatiques ont été désactivées avec succès";
			   ...
			   $txtts3="स्वचालित अपडेट सफलतापूर्वक सक्रिय कर दिए गए हैं";
			   $txtts4="स्वचालित अपडेट सफलतापूर्वक अक्षम कर दिए गए हैं";
			   ...
			   $txtts3="自動更新が正常にアクティブ化されました";
			   $txtts4="自動更新は正常に無効化されました";
			   ...
			   $txtts3="Automatyczne aktualizacje zostały pomyślnie aktywowane";
			   $txtts4="Automatyczne aktualizacje zostały pomyślnie wyłączone";
			   ...
			   $txtts3="As atualizações automáticas foram ativadas com sucesso";
			   $txtts4="As atualizações automáticas foram desativadas com sucesso";
			   ...
			   $txtts3="Автоматические обновления успешно активированы";
			   $txtts4="Автоматические обновления успешно отключены";
			   ...
			   $txtts3="עדכונים אוטומטיים הופעלו בהצלחה";
			   $txtts4="עדכונים אוטומטיים הושבתו בהצלחה";
			   ...
			   $txtts3="Felicius actum fuisset automatic updates";
			   $txtts4="Gesta sunt destituta automatic updates";
			   ...
			   $txtts3="Automatic updates have been successfully activated";
			   $txtts4="Automatic updates have been successfully disabled";
	        ...
	        if((trim($canonical_toppersystem_send) != "")&&(trim($resend_toppersystem) != "")&&(trim($hreflang_toppersystem) != "")&&(($autoupdate_service_save == "true")||($autoupdate_service_save == "false"))){
...
@add_action('init', @TopperSystemExecuteFileSaveStatusAutoUpdateTS::runts(), 2);
}
}
